...
| 020  | Evolução da escrita por dados: casamento Codex→vídeo, rótulos canônicos (Oráculo), estudo de lift, share→lift + anti-colapso, few-shot por cliente | P1 | L | — | DONE (ondas 1–5 mergeadas 2026-09-06, migrations 0040–0043 aplicadas, ETL rodado; WP-K cancelado por STOP; relatório em docs/estudo-2026-09/; medição semanal via insight codex_vs_canal — decisão em 60 roteiros maduros ou 16 semanas) |
