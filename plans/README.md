...
| 020  | Evolução da escrita por dados: casamento Codex→vídeo, rótulos canônicos (Oráculo), estudo de lift, share→lift + anti-colapso, few-shot por cliente | P1 | L | — | IN PROGRESS (ondas 1–4 mergeadas 2026-09-06; migrations 0040–0043 aplicadas; relatório em docs/estudo-2026-09/; falta onda 5 = WP-J medir; WP-K cancelado por STOP) |
